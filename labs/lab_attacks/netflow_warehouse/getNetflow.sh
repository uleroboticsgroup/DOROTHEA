...
if [ $var -eq 1 ]; then
	...
	sleep 120
    #transform the flows saved in the router into a single csv
    ...
    sshpass -p "password" ssh -o StrictHostKeyChecking=no root@152.148.48.254  "echo 2 > /checkAttackerReceiver.txt"
