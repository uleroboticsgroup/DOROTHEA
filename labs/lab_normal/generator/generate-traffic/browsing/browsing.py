...
def main(mode):
	...
	browse = '/generate-traffic/browsing/bbrowsing.txt'
	slist = '/generate-traffic/browsing/businessSearch.txt'
	if mode == 'p':
		browse = '/generate-traffic/browsing/pbrowsing.txt'
		slist = '/generate-traffic/browsing/privateSearch.txt'
	
	# Read private or business page from ini file
	parser = SafeConfigParser()
	parser.read('/generate-traffic/browsing/browser.ini')
