...
insmod ipt-netflow/ipt_NETFLOW.ko destination=152.148.48.4:2055 debug=1
...
iptables -A OUTPUT -o eth0 -p tcp --sport 22 -d 152.148.48.2 -m state --state ESTABLISHED -j ACCEPT
